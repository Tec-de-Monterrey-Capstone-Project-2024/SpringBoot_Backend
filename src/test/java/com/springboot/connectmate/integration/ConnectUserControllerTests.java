...
public class ConnectUserControllerTests {
    ...
    public void givenInstanceIdAndUserId_whenGetUserDescription_thenReturnUser() throws Exception {
        ...
        String userId = "ed1ad50d-2ffc-44ad-a565-71f13ad991a5";
        User expectedUser = new User();

        // when - action or behaviour tested
        ResultActions response = mockMvc.perform(get("/api/amazon-connect/instances/{instanceId}/users/{userId}/description", instanceId,userId)
    ...
    public void givenInstanceId_whenGetAgentStatuses_thenReturnAgentStatuses() throws Exception {
        ...
        ResultActions response = mockMvc.perform(get("/api/amazon-connect/instances/{instanceId}/agent-statuses", instanceId)
                .contentType(MediaType.APPLICATION_JSON)
