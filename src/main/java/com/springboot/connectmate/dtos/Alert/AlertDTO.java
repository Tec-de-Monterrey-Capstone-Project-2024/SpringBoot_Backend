...
@Data
@Schema(name = "Alert", description = "DTO for Alert")
public class AlertDTO {

    @Schema(description = "Id of the Alert", example = "1")
    private Long id;

    @Schema(description = "Metric Description associated with this alert. " +
            "Contains details such as metric ID, code, and description related to the specific metric causing the alert.")
    ...
    @Schema(description = "Occurred At of the Alert", example = "2021-07-01T00:00:00")
