...
public enum ResponseField {
   ...
   SUMMARY("Analyze the following KPI data of a contact center and its threshold breach. Generate the insight summary and return it. This field should contain a brief summary of the insight."),
    ...
    ACTION("Analyze the following KPI data of a contact center and its threshold breach. Generate the insight actions and return it. This field should contain recommended actions to address the threshold breach."),
    CATEGORY("Analyze the following KPI data of a contact center and its threshold breach. Generate the insight category and return it. This field should only contain the severity level of the threshold breach (LOW,MEDIUM,HIGH)."),
    PERFORMANCE("Analyze the following KPI data of a contact center and its threshold breach. Generate the insight performance and return it. This field should contain the performance level of the threshold breach (CRITICAL, UNSATISFACTORY, BELOW_EXPECTATIONS, EXCEEDS_EXPECTATIONS, OUTSTANDING,PIONEERING)"),
